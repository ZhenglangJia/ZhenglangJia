...
My research interests include **computational electromagnetics**, **multiphysics modeling and simulation**, **scientific machine learning**, and **AI for antenna system**. I am particularly passionate about developing AI-driven approaches to accelerate traditional electromagnetic simulations and solve complex multiphysics problems.
...
- **Multiphysics-Inspired Neural Network for Efficient Beam Pattern Prediction of Radome-Enclosed High-Power Phased Array Antenna**<br>
  Zheng Jun Shen<sup>&dagger, **Zheng Lang Jia**, Bian Wu, Huan Huan Zhang*.<br>
...
- **Electromagnetic-Thermal Cosimulation via Divide-and-Conquer PINNs**<br>
  ...
  *IEEE Antennas and Wireless Propagation Letters (JCR Q1), 2025.* <br>
